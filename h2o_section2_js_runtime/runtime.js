...
//         },
//         sarcasm: (...args) => {
//             const message = argsToMessage(...args) + " " + "Whoo! we did it ra mavaneyyy!"
...
((globalThis) => {
    ...
    "Oh, brilliant ideal", "Wow,never heard that one before...", "Oh, how original...",
    "Congratulations, you broke the codel", "Great job, you found a bug!", "Keep up the good work, geniust",
